      ...
      <div className={styles.headerContent}>
        ...
        <nav className={`${styles.navigation} ${isMenuOpen ? styles.active : ``}`}>
          <ul className={styles.navList}>
            ...
            <li><Link to="/team" onClick={handleLinkClick}>Наша команда</Link></li>
            <li><Link to="/services" onClick={handleLinkClick}>Услуги</Link></li>
            <li><Link to="/photo" onClick={handleLinkClick}>Фото с мероприятий</Link></li>
